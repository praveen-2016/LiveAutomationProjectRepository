...
public class TC_RF_004
{
	...
	@Test
	public void validationOfAllMandatoryfieldsWarningMessages()
	{
	      ...
	      String warning1="Warning: You must agree to the Privacy Policy!";
	      softAssert.assertEquals(driver.findElement(By.xpath("//div[@class='alert alert-danger alert-dismissible']")).getText(), warning1);
